// Privacy page TSX template — consumed by PipelineKit's /metadata agent.
...
// {{IF feature}} ... {{/IF}} markers — the agent removes the whole block
// (including markers) when `feature` is not declared in the privacy manifest.
    ...
    <div className="px-6 pt-36 pb-24">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-16 space-y-12 text-[15px] leading-[1.8] text-muted">
          ...
          <FadeIn>
            <section>
              <h2 className="text-xl font-semibold text-foreground">Third-Party Lookups</h2>
              <p className="mt-4">
